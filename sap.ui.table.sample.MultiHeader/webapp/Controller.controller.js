sap.ui.define([
	...
	return Controller.extend("sap.ui.table.sample.MultiHeader.Controller", {
		...
		/*
		  ...
		  var oColumn = this.getView().byId("supplierColumn");
		  var oColumnHeader = oColumn.$().context
		  oColumnHeader.setAttribute('rowspan', '2');
		  console.log(oColumn.$().context);

		  var oColumn = this.getView().byId("supplierColumn2");
		  var oColumnHeader = oColumn.$().context
		  oColumnHeader.setAttribute('rowspan', '2');
	  },
		*/
